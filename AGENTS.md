...
Include when zipping for upload:

- `BAX423_HW2_Part1_WriteUp.pdf`
- `BAX423_HW2_WrittenResponses_Parts2-4.pdf`
- `countminSketchHW.ipynb`, `UNSW_LightGBM.ipynb`, `RangeQueryText.ipynb`
- `CMS.json`, `unsw_nb15_lightgbm_measurements.json`, `TextRangeQueries.json`
- Your Part 3 multiclass explanation `.mp4` (about three minutes)

Do not put in the student zip:
